...
faulty recyclable products. Companies are avoiding making real change. Companies 
...
```{r ggplot-research-q2, message = FALSE, warning = FALSE, echo=FALSE}
...
RQ3: According to our methodology, the difference in 
...
We used these three research questions to investigate our
overarching question about the  the plastic pollution
of the US and China. Our first question addressed
the differences in grand total for a parent company in each
country while the latter two explored the differences between plastic type
and year. We found that the average parent company did not produce 
significantly different amounts of pollution and that the differences
between years and plastic types were negligible. As such, there
is still much to be investigated about this topic as plastic pollution
